      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        >
              ...
              <a
                ...
                :class="[
                  item.current
                    ...
                    : 'text-black-600 hover:bg-gray-700 hover:text-white',
          ...
          >
            <a
             href="/shoppingcart">
              <CartIcon class="rounded-full p-0.5 h-7 w-auto hidden sm:ml-6 sm:block hover:text-white hover:bg-gray-700" />
            </a>
          </div>
        </div>
